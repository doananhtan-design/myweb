...
function Courses() {
  const items = [
    ...
    { title: "Bổ Túc tay Lái ", text: "Bổ túc tay lái trong hình - đường trường.", price: "Liên hệ" },
    { title: "Ôn luyện", text: "Luyện thi Lý thuyết và Mô phỏng.", price: "Liên hệ" },
];
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <motion.div className="md:col-span-2 bg-white rounded-xl p-6 shadow-md" initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <SelectField id="course" label="Khóa học" value={formData.course} onChange={handleChange} options={["A/A1", "B_ck", "B_tđ (Tự động)", "C", "BT", "OL"]} />
